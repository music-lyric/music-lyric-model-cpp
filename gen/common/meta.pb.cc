...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        // ::lyric::common::MetaText
        {&::_pbi::kDescriptorMethods, &::descriptor_table_common_2fmeta_2eproto, /* tracker*/ nullptr,},
        // ::lyric::common::MetaCredit
        {&::_pbi::kDescriptorMethods, &::descriptor_table_common_2fmeta_2eproto, /* tracker*/ nullptr,},
        // ::lyric::common::MetaReference
        {&::_pbi::kDescriptorMethods, &::descriptor_table_common_2fmeta_2eproto, /* tracker*/ nullptr,},
        // ::lyric::common::Meta
        {&::_pbi::kDescriptorMethods, &::descriptor_table_common_2fmeta_2eproto, /* tracker*/ nullptr,},
};
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GetTable<::lyric::common::MetaText>(),  // to_prefetch
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GenericFallback,  // fallback
      #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
      ::_pbi::TcParser::GetTable<::lyric::common::MetaReference>(),  // to_prefetch
      #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
    }, {{
    ...
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        ids_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::common::MetaReference,
            PROTOBUF_FIELD_OFFSET(::lyric::common::MetaReference, _impl_.ids_)>()
         }
        ,
        platform_(
            &::google::protobuf::internal::fixed_address_empty_string,
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GenericFallback,  // fallback
      #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
      ::_pbi::TcParser::GetTable<::lyric::common::MetaCredit>(),  // to_prefetch
      #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
    }, {{
    ...
    {{
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::lyric::common::MetaText>()},
        #else
        {::_pbi::FieldAuxMessageGlobals(), &::lyric::common::MetaText_globals_},
        #endif
    }},
    {{
      "\27\4\0\0\0\0\0\0"
    ...
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        names_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::common::MetaCredit,
            PROTOBUF_FIELD_OFFSET(::lyric::common::MetaCredit, _impl_.names_)>()
         }
        ,
        role_(
            &::google::protobuf::internal::fixed_address_empty_string,
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GenericFallback,  // fallback
      #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
      ::_pbi::TcParser::GetTable<::lyric::common::Meta>(),  // to_prefetch
      #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
    }, {{
    ...
    {{
        ...
        #endif
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::lyric::common::MetaCredit>()},
        #else
        {::_pbi::FieldAuxMessageGlobals(), &::lyric::common::MetaCredit_globals_},
        #endif
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::lyric::common::MetaReference>()},
        #else
        {::_pbi::FieldAuxMessageGlobals(), &::lyric::common::MetaReference_globals_},
        #endif
    }},
    {{
    ...
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        unknowns_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::common::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.unknowns_)>()
         }
        ,
        titles_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::common::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.titles_)>()
         }
        ,
        artists_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::common::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.artists_)>()
         }
        ,
        albums_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::common::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.albums_)>()
         }
        ,
        authors_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::common::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.authors_)>()
         }
        ,
        isrcs_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::common::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.isrcs_)>()
         }
        ,
        credits_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::common::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.credits_)>()
         }
        ,
        references_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::common::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.references_)>()
         }
        ,
        offset_{0},
        duration_{0u} {}
...
static constexpr const ::_pb::EnumDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_enum_descriptors_common_2fmeta_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_service_descriptors_common_2fmeta_2eproto = nullptr;
const ::uint32_t
    TableStruct_common_2fmeta_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::common::MetaText, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::common::MetaText, _impl_.language_),
        PROTOBUF_FIELD_OFFSET(::lyric::common::MetaText, _impl_.content_),
        0,
        1,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::common::MetaCredit, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::common::MetaCredit, _impl_.role_),
        PROTOBUF_FIELD_OFFSET(::lyric::common::MetaCredit, _impl_.names_),
        1,
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::common::MetaReference, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::common::MetaReference, _impl_.platform_),
        PROTOBUF_FIELD_OFFSET(::lyric::common::MetaReference, _impl_.ids_),
        1,
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_._has_bits_),
        13, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.unknowns_),
        PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.offset_),
        PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.duration_),
        PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.titles_),
        PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.artists_),
        PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.albums_),
        PROTOBUF_FIELD_OFFSET(::lyric::common::Meta, _impl_.authors_),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::lyric::common::MetaText)},
        {7, sizeof(::lyric::common::MetaCredit)},
        {14, sizeof(::lyric::common::MetaReference)},
        {21, sizeof(::lyric::common::Meta)},
};
static const ::_pbi::MessageGlobalsBase* PROTOBUF_NONNULL const
    file_message_globals[] = {
        &::lyric::common::MetaText_globals_,
        &::lyric::common::MetaCredit_globals_,
        &::lyric::common::MetaReference_globals_,
        &::lyric::common::Meta_globals_,
};
const char descriptor_table_protodef_common_2fmeta_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\021common/meta.proto\022\014lyric.common\032\024commo"
    "n/unknown.proto\"R\n\010MetaText\022\037\n\010language\030"
    "\001 \001(\tH\000R\010language\210\001\001\022\030\n\007content\030\002 \001(\tR\007c"
    "ontentB\013\n\t_language\"N\n\nMetaCredit\022\022\n\004rol"
    "e\030\001 \001(\tR\004role\022,\n\005names\030\002 \003(\0132\026.lyric.com"
    "mon.MetaTextR\005names\"=\n\rMetaReference\022\032\n\010"
    "platform\030\001 \001(\tR\010platform\022\020\n\003ids\030\002 \003(\tR\003i"
    "ds\"\270\003\n\004Meta\0221\n\010unknowns\030\001 \003(\0132\025.lyric.co"
    "mmon.UnknownR\010unknowns\022\026\n\006offset\030\002 \001(\021R\006"
    "offset\022\032\n\010duration\030\003 \001(\rR\010duration\022.\n\006ti"
    "tles\030\004 \003(\0132\026.lyric.common.MetaTextR\006titl"
    "es\0220\n\007artists\030\005 \003(\0132\026.lyric.common.MetaT"
    "extR\007artists\022.\n\006albums\030\006 \003(\0132\026.lyric.com"
    "mon.MetaTextR\006albums\0220\n\007authors\030\007 \003(\0132\026."
    "lyric.common.MetaTextR\007authors\022\024\n\005isrcs\030"
    "\010 \003(\tR\005isrcs\0222\n\007credits\030\t \003(\0132\030.lyric.co"
    "mmon.MetaCreditR\007credits\022;\n\nreferences\030\n"
    " \003(\0132\033.lyric.common.MetaReferenceR\nrefer"
    "encesb\006proto3"
};
static const ::_pbi::DescriptorTable* PROTOBUF_NONNULL const
    descriptor_table_common_2fmeta_2eproto_deps[1] = {
        &::descriptor_table_common_2funknown_2eproto,
};
static ::absl::once_flag descriptor_table_common_2fmeta_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_common_2fmeta_2eproto = {
    false,
    false,
    733,
    descriptor_table_protodef_common_2fmeta_2eproto,
    "common/meta.proto",
    &descriptor_table_common_2fmeta_2eproto_once,
    descriptor_table_common_2fmeta_2eproto_deps,
    1,
    4,
    schemas,
    file_message_globals,
    TableStruct_common_2fmeta_2eproto::offsets,
    file_level_enum_descriptors_common_2fmeta_2eproto,
    file_level_service_descriptors_common_2fmeta_2eproto,
};
namespace lyric {
namespace common {
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.common.MetaText)
}
PROTOBUF_NDEBUG_INLINE MetaText::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::common::MetaText& from_msg)
...
MetaText::MetaText(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.common.MetaText)
}
PROTOBUF_NDEBUG_INLINE MetaText::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
...
MetaText::~MetaText() {
  // @@protoc_insertion_point(destructor:lyric.common.MetaText)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.common.MetaText)
...
::uint8_t* PROTOBUF_NONNULL MetaText::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.common.MetaText)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.common.MetaText.language");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_content().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.common.MetaText.content");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.common.MetaText)
  return target;
}
...
::size_t MetaText::ByteSizeLong() const {
  const MetaText& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.common.MetaText)
  ::size_t total_size = 0;
...
void MetaText::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.common.MetaText)
...
void MetaText::CopyFrom(const MetaText& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.common.MetaText)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.common.MetaCredit)
}
PROTOBUF_NDEBUG_INLINE MetaCredit::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::common::MetaCredit& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        names_ {
...
MetaCredit::MetaCredit(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.common.MetaCredit)
}
PROTOBUF_NDEBUG_INLINE MetaCredit::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
MetaCredit::~MetaCredit() {
  // @@protoc_insertion_point(destructor:lyric.common.MetaCredit)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.common.MetaCredit)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL MetaCredit::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.common.MetaCredit)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_role().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.common.MetaCredit.role");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.common.MetaCredit)
  return target;
}
...
::size_t MetaCredit::ByteSizeLong() const {
  const MetaCredit& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.common.MetaCredit)
  ::size_t total_size = 0;
...
void MetaCredit::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.common.MetaCredit)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
...
void MetaCredit::CopyFrom(const MetaCredit& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.common.MetaCredit)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.common.MetaReference)
}
PROTOBUF_NDEBUG_INLINE MetaReference::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::common::MetaReference& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        ids_ {
          visibility, ::_pbi::InternalMetadataOffset::Build<
...
MetaReference::MetaReference(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.common.MetaReference)
}
PROTOBUF_NDEBUG_INLINE MetaReference::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
MetaReference::~MetaReference() {
  // @@protoc_insertion_point(destructor:lyric.common.MetaReference)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.common.MetaReference)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL MetaReference::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.common.MetaReference)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_platform().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.common.MetaReference.platform");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    for (int i = 0, n = this_._internal_ids_size(); i < n; ++i) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          s.data(), static_cast<int>(s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.common.MetaReference.ids");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.common.MetaReference)
  return target;
}
...
::size_t MetaReference::ByteSizeLong() const {
  const MetaReference& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.common.MetaReference)
  ::size_t total_size = 0;
...
void MetaReference::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  ::google::protobuf::Arena* arena = _this->GetArena();
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.common.MetaReference)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
...
void MetaReference::CopyFrom(const MetaReference& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.common.MetaReference)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.common.Meta)
}
PROTOBUF_NDEBUG_INLINE Meta::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::common::Meta& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        unknowns_ {
          visibility, ::_pbi::InternalMetadataOffset::Build<
...
Meta::Meta(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.common.Meta)
}
PROTOBUF_NDEBUG_INLINE Meta::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
Meta::~Meta() {
  // @@protoc_insertion_point(destructor:lyric.common.Meta)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.common.Meta)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL Meta::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.common.Meta)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000020U)) {
    for (int i = 0, n = this_._internal_isrcs_size(); i < n; ++i) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          s.data(), static_cast<int>(s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.common.Meta.isrcs");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.common.Meta)
  return target;
}
...
::size_t Meta::ByteSizeLong() const {
  const Meta& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.common.Meta)
  ::size_t total_size = 0;
...
void Meta::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  ::google::protobuf::Arena* arena = _this->GetArena();
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.common.Meta)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
...
void Meta::CopyFrom(const Meta& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.common.Meta)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_common_2fmeta_2eproto),
         ::std::false_type{});
