...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        // ::lyric::runtime::Part
        {&::_pbi::kDescriptorMethods, &::descriptor_table_runtime_2fpart_2fpart_2eproto, /* tracker*/ nullptr,},
};
}  // namespace
#endif
namespace lyric {
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GetTable<::lyric::runtime::Part>(),  // to_prefetch
...
static constexpr const ::_pb::EnumDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_enum_descriptors_runtime_2fpart_2fpart_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_service_descriptors_runtime_2fpart_2fpart_2eproto = nullptr;
const ::uint32_t
    TableStruct_runtime_2fpart_2fpart_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::Part, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::Part, _impl_.type_),
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::Part, _impl_.label_),
        1,
        0,
};
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::lyric::runtime::Part)},
};
static const ::_pbi::MessageGlobalsBase* PROTOBUF_NONNULL const
    file_message_globals[] = {
        &::lyric::runtime::Part_globals_,
};
const char descriptor_table_protodef_runtime_2fpart_2fpart_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\027runtime/part/part.proto\022\rlyric.runtime"
...
static const ::_pbi::DescriptorTable* PROTOBUF_NONNULL const
    descriptor_table_runtime_2fpart_2fpart_2eproto_deps[1] = {
        &::descriptor_table_common_2fpart_2eproto,
};
static ::absl::once_flag descriptor_table_runtime_2fpart_2fpart_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_runtime_2fpart_2fpart_2eproto = {
    false,
    false,
    156,
    descriptor_table_protodef_runtime_2fpart_2fpart_2eproto,
    "runtime/part/part.proto",
    &descriptor_table_runtime_2fpart_2fpart_2eproto_once,
    descriptor_table_runtime_2fpart_2fpart_2eproto_deps,
    1,
    1,
    schemas,
    file_message_globals,
    TableStruct_runtime_2fpart_2fpart_2eproto::offsets,
    file_level_enum_descriptors_runtime_2fpart_2fpart_2eproto,
    file_level_service_descriptors_runtime_2fpart_2fpart_2eproto,
};
namespace lyric {
namespace runtime {
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.runtime.Part)
}
PROTOBUF_NDEBUG_INLINE Part::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::runtime::Part& from_msg)
...
Part::Part(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.runtime.Part)
}
PROTOBUF_NDEBUG_INLINE Part::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
...
Part::~Part() {
  // @@protoc_insertion_point(destructor:lyric.runtime.Part)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.runtime.Part)
...
::uint8_t* PROTOBUF_NONNULL Part::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.runtime.Part)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.runtime.Part.label");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.runtime.Part)
  return target;
}
...
::size_t Part::ByteSizeLong() const {
  const Part& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.runtime.Part)
  ::size_t total_size = 0;
...
void Part::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.runtime.Part)
...
void Part::CopyFrom(const Part& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.runtime.Part)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_runtime_2fpart_2fpart_2eproto),
         ::std::false_type{});
