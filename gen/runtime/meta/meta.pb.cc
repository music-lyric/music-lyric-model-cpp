...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        // ::lyric::runtime::MetaText
        {&::_pbi::kDescriptorMethods, &::descriptor_table_runtime_2fmeta_2fmeta_2eproto, /* tracker*/ nullptr,},
        // ::lyric::runtime::MetaCredit
        {&::_pbi::kDescriptorMethods, &::descriptor_table_runtime_2fmeta_2fmeta_2eproto, /* tracker*/ nullptr,},
        // ::lyric::runtime::MetaUnknown
        {&::_pbi::kDescriptorMethods, &::descriptor_table_runtime_2fmeta_2fmeta_2eproto, /* tracker*/ nullptr,},
        // ::lyric::runtime::MetaReference
        {&::_pbi::kDescriptorMethods, &::descriptor_table_runtime_2fmeta_2fmeta_2eproto, /* tracker*/ nullptr,},
        // ::lyric::runtime::Meta
        {&::_pbi::kDescriptorMethods, &::descriptor_table_runtime_2fmeta_2fmeta_2eproto, /* tracker*/ nullptr,},
};
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GetTable<::lyric::runtime::MetaUnknown>(),  // to_prefetch
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GenericFallback,  // fallback
      #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
      ::_pbi::TcParser::GetTable<::lyric::runtime::MetaText>(),  // to_prefetch
      #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
    }, {{
      // string content = 2 [json_name = "content"];
      {::_pbi::TcParser::FastUS1,
       {18, 1, 0,
        PROTOBUF_FIELD_OFFSET(MetaText, _impl_.content_)}},
      ...
      // string content = 2 [json_name = "content"];
      {PROTOBUF_FIELD_OFFSET(MetaText, _impl_.content_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    }},
    // no aux_entries
    {{
      "\26\10\7\0\0\0\0\0"
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GenericFallback,  // fallback
      #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
      ::_pbi::TcParser::GetTable<::lyric::runtime::MetaReference>(),  // to_prefetch
      #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
    }, {{
    ...
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        ids_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::runtime::MetaReference,
            PROTOBUF_FIELD_OFFSET(::lyric::runtime::MetaReference, _impl_.ids_)>()
         }
        ,
        platform_(
            &::google::protobuf::internal::fixed_address_empty_string,
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GenericFallback,  // fallback
      #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
      ::_pbi::TcParser::GetTable<::lyric::runtime::MetaCredit>(),  // to_prefetch
      #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
    }, {{
    ...
    {{
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::lyric::runtime::MetaText>()},
        #else
        {::_pbi::FieldAuxMessageGlobals(), &::lyric::runtime::MetaText_globals_},
        #endif
    }},
    {{
      "\30\4\0\0\0\0\0\0"
    ...
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        names_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::runtime::MetaCredit,
            PROTOBUF_FIELD_OFFSET(::lyric::runtime::MetaCredit, _impl_.names_)>()
         }
        ,
        role_(
            &::google::protobuf::internal::fixed_address_empty_string,
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GenericFallback,  // fallback
      #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
      ::_pbi::TcParser::GetTable<::lyric::runtime::Meta>(),  // to_prefetch
      #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
    }, {{
    ...
    {{
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::lyric::runtime::MetaUnknown>()},
        #else
        {::_pbi::FieldAuxMessageGlobals(), &::lyric::runtime::MetaUnknown_globals_},
        #endif
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::lyric::runtime::MetaText>()},
        #else
        ...
        #endif
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::lyric::runtime::MetaCredit>()},
        #else
        {::_pbi::FieldAuxMessageGlobals(), &::lyric::runtime::MetaCredit_globals_},
        #endif
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::lyric::runtime::MetaReference>()},
        #else
        {::_pbi::FieldAuxMessageGlobals(), &::lyric::runtime::MetaReference_globals_},
        #endif
    }},
    {{
      "\22\0\0\0\0\0\0\0\5\0\0\0\0\0\0\0"
      "lyric.runtime.Meta"
      "isrcs"
    }},
  };
    ...
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        unknowns_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::runtime::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.unknowns_)>()
         }
        ,
        titles_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::runtime::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.titles_)>()
         }
        ,
        artists_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::runtime::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.artists_)>()
         }
        ,
        albums_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::runtime::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.albums_)>()
         }
        ,
        authors_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::runtime::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.authors_)>()
         }
        ,
        isrcs_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::runtime::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.isrcs_)>()
         }
        ,
        credits_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::runtime::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.credits_)>()
         }
        ,
        references_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::runtime::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.references_)>()
         }
        ,
        offset_{0},
        duration_{0u} {}
...
static constexpr const ::_pb::EnumDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_enum_descriptors_runtime_2fmeta_2fmeta_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_service_descriptors_runtime_2fmeta_2fmeta_2eproto = nullptr;
const ::uint32_t
    TableStruct_runtime_2fmeta_2fmeta_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::MetaText, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::MetaText, _impl_.language_),
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::MetaText, _impl_.content_),
        0,
        1,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::MetaCredit, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::MetaCredit, _impl_.role_),
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::MetaCredit, _impl_.names_),
        1,
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::MetaUnknown, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::MetaUnknown, _impl_.key_),
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::MetaUnknown, _impl_.value_),
        0,
        1,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::MetaReference, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::MetaReference, _impl_.platform_),
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::MetaReference, _impl_.ids_),
        1,
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_._has_bits_),
        13, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.unknowns_),
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.offset_),
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.duration_),
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.titles_),
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.artists_),
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.albums_),
        PROTOBUF_FIELD_OFFSET(::lyric::runtime::Meta, _impl_.authors_),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::lyric::runtime::MetaText)},
        {7, sizeof(::lyric::runtime::MetaCredit)},
        {14, sizeof(::lyric::runtime::MetaUnknown)},
        {21, sizeof(::lyric::runtime::MetaReference)},
        {28, sizeof(::lyric::runtime::Meta)},
};
static const ::_pbi::MessageGlobalsBase* PROTOBUF_NONNULL const
    file_message_globals[] = {
        &::lyric::runtime::MetaText_globals_,
        &::lyric::runtime::MetaCredit_globals_,
        &::lyric::runtime::MetaUnknown_globals_,
        &::lyric::runtime::MetaReference_globals_,
        &::lyric::runtime::Meta_globals_,
};
const char descriptor_table_protodef_runtime_2fmeta_2fmeta_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\027runtime/meta/meta.proto\022\rlyric.runtime"
    "\"R\n\010MetaText\022\037\n\010language\030\001 \001(\tH\000R\010langua"
    "ge\210\001\001\022\030\n\007content\030\002 \001(\tR\007contentB\013\n\t_lang"
    "uage\"O\n\nMetaCredit\022\022\n\004role\030\001 \001(\tR\004role\022-"
    "\n\005names\030\002 \003(\0132\027.lyric.runtime.MetaTextR\005"
    "names\"5\n\013MetaUnknown\022\020\n\003key\030\001 \001(\tR\003key\022\024"
    "\n\005value\030\002 \001(\tR\005value\"=\n\rMetaReference\022\032\n"
    "\010platform\030\001 \001(\tR\010platform\022\020\n\003ids\030\002 \003(\tR\003"
    "ids\"\303\003\n\004Meta\0226\n\010unknowns\030\001 \003(\0132\032.lyric.r"
    "untime.MetaUnknownR\010unknowns\022\026\n\006offset\030\002"
    " \001(\021R\006offset\022\032\n\010duration\030\003 \001(\rR\010duration"
    "\022/\n\006titles\030\004 \003(\0132\027.lyric.runtime.MetaTex"
    "tR\006titles\0221\n\007artists\030\005 \003(\0132\027.lyric.runti"
    "me.MetaTextR\007artists\022/\n\006albums\030\006 \003(\0132\027.l"
    "yric.runtime.MetaTextR\006albums\0221\n\007authors"
    "\030\007 \003(\0132\027.lyric.runtime.MetaTextR\007authors"
    "\022\024\n\005isrcs\030\010 \003(\tR\005isrcs\0223\n\007credits\030\t \003(\0132"
    "\031.lyric.runtime.MetaCreditR\007credits\022<\n\nr"
    "eferences\030\n \003(\0132\034.lyric.runtime.MetaRefe"
    "renceR\nreferencesb\006proto3"
};
static ::absl::once_flag descriptor_table_runtime_2fmeta_2fmeta_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_runtime_2fmeta_2fmeta_2eproto = {
    false,
    false,
    785,
    descriptor_table_protodef_runtime_2fmeta_2fmeta_2eproto,
    "runtime/meta/meta.proto",
    &descriptor_table_runtime_2fmeta_2fmeta_2eproto_once,
    nullptr,
    0,
    5,
    schemas,
    file_message_globals,
    TableStruct_runtime_2fmeta_2fmeta_2eproto::offsets,
    file_level_enum_descriptors_runtime_2fmeta_2fmeta_2eproto,
    file_level_service_descriptors_runtime_2fmeta_2fmeta_2eproto,
};
namespace lyric {
namespace runtime {
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.runtime.MetaText)
}
PROTOBUF_NDEBUG_INLINE MetaText::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::runtime::MetaText& from_msg)
...
MetaText::MetaText(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.runtime.MetaText)
}
PROTOBUF_NDEBUG_INLINE MetaText::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
...
MetaText::~MetaText() {
  // @@protoc_insertion_point(destructor:lyric.runtime.MetaText)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.runtime.MetaText)
...
::uint8_t* PROTOBUF_NONNULL MetaText::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.runtime.MetaText)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.runtime.MetaText.language");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_content().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.runtime.MetaText.content");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.runtime.MetaText)
  return target;
}
...
::size_t MetaText::ByteSizeLong() const {
  const MetaText& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.runtime.MetaText)
  ::size_t total_size = 0;
...
void MetaText::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.runtime.MetaText)
...
void MetaText::CopyFrom(const MetaText& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.runtime.MetaText)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.runtime.MetaCredit)
}
PROTOBUF_NDEBUG_INLINE MetaCredit::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::runtime::MetaCredit& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        names_ {
...
MetaCredit::MetaCredit(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.runtime.MetaCredit)
}
PROTOBUF_NDEBUG_INLINE MetaCredit::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
MetaCredit::~MetaCredit() {
  // @@protoc_insertion_point(destructor:lyric.runtime.MetaCredit)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.runtime.MetaCredit)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL MetaCredit::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.runtime.MetaCredit)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_role().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.runtime.MetaCredit.role");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.runtime.MetaCredit)
  return target;
}
...
::size_t MetaCredit::ByteSizeLong() const {
  const MetaCredit& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.runtime.MetaCredit)
  ::size_t total_size = 0;
...
void MetaCredit::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.runtime.MetaCredit)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
...
void MetaCredit::CopyFrom(const MetaCredit& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.runtime.MetaCredit)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.runtime.MetaUnknown)
}
PROTOBUF_NDEBUG_INLINE MetaUnknown::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::runtime::MetaUnknown& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
MetaUnknown::MetaUnknown(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.runtime.MetaUnknown)
}
PROTOBUF_NDEBUG_INLINE MetaUnknown::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
MetaUnknown::~MetaUnknown() {
  // @@protoc_insertion_point(destructor:lyric.runtime.MetaUnknown)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.runtime.MetaUnknown)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL MetaUnknown::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.runtime.MetaUnknown)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    if (!this_._internal_key().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.runtime.MetaUnknown.key");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_value().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.runtime.MetaUnknown.value");
      target = stream->WriteStringMaybeAliased(2, _s, target);
    }
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.runtime.MetaUnknown)
  return target;
}
...
::size_t MetaUnknown::ByteSizeLong() const {
  const MetaUnknown& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.runtime.MetaUnknown)
  ::size_t total_size = 0;
...
void MetaUnknown::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.runtime.MetaUnknown)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
...
void MetaUnknown::CopyFrom(const MetaUnknown& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.runtime.MetaUnknown)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.runtime.MetaReference)
}
PROTOBUF_NDEBUG_INLINE MetaReference::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::runtime::MetaReference& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        ids_ {
          visibility, ::_pbi::InternalMetadataOffset::Build<
...
MetaReference::MetaReference(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.runtime.MetaReference)
}
PROTOBUF_NDEBUG_INLINE MetaReference::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
MetaReference::~MetaReference() {
  // @@protoc_insertion_point(destructor:lyric.runtime.MetaReference)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.runtime.MetaReference)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL MetaReference::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.runtime.MetaReference)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_platform().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.runtime.MetaReference.platform");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    for (int i = 0, n = this_._internal_ids_size(); i < n; ++i) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          s.data(), static_cast<int>(s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.runtime.MetaReference.ids");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.runtime.MetaReference)
  return target;
}
...
::size_t MetaReference::ByteSizeLong() const {
  const MetaReference& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.runtime.MetaReference)
  ::size_t total_size = 0;
...
void MetaReference::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  ::google::protobuf::Arena* arena = _this->GetArena();
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.runtime.MetaReference)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
...
void MetaReference::CopyFrom(const MetaReference& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.runtime.MetaReference)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.runtime.Meta)
}
PROTOBUF_NDEBUG_INLINE Meta::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::runtime::Meta& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        unknowns_ {
          visibility, ::_pbi::InternalMetadataOffset::Build<
...
Meta::Meta(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.runtime.Meta)
}
PROTOBUF_NDEBUG_INLINE Meta::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
Meta::~Meta() {
  // @@protoc_insertion_point(destructor:lyric.runtime.Meta)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.runtime.Meta)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL Meta::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.runtime.Meta)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000020U)) {
    for (int i = 0, n = this_._internal_isrcs_size(); i < n; ++i) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          s.data(), static_cast<int>(s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.runtime.Meta.isrcs");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.runtime.Meta)
  return target;
}
...
::size_t Meta::ByteSizeLong() const {
  const Meta& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.runtime.Meta)
  ::size_t total_size = 0;
...
void Meta::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  ::google::protobuf::Arena* arena = _this->GetArena();
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.runtime.Meta)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
...
void Meta::CopyFrom(const Meta& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.runtime.Meta)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_runtime_2fmeta_2fmeta_2eproto),
         ::std::false_type{});
