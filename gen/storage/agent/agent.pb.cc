...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        // ::lyric::storage::AgentItem
        {&::_pbi::kDescriptorMethods, &::descriptor_table_storage_2fagent_2fagent_2eproto, /* tracker*/ nullptr,},
};
}  // namespace
#endif
namespace lyric {
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GetTable<::lyric::storage::AgentItem>(),  // to_prefetch
    ...
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        names_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::storage::AgentItem,
            PROTOBUF_FIELD_OFFSET(::lyric::storage::AgentItem, _impl_.names_)>()
         }
        ,
        id_(
...
static constexpr const ::_pb::EnumDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_enum_descriptors_storage_2fagent_2fagent_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_service_descriptors_storage_2fagent_2fagent_2eproto = nullptr;
const ::uint32_t
    TableStruct_storage_2fagent_2fagent_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::storage::AgentItem, _impl_._has_bits_),
        6, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::storage::AgentItem, _impl_.id_),
        PROTOBUF_FIELD_OFFSET(::lyric::storage::AgentItem, _impl_.type_),
        PROTOBUF_FIELD_OFFSET(::lyric::storage::AgentItem, _impl_.names_),
        1,
        2,
        0,
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::lyric::storage::AgentItem)},
};
static const ::_pbi::MessageGlobalsBase* PROTOBUF_NONNULL const
    file_message_globals[] = {
        &::lyric::storage::AgentItem_globals_,
};
const char descriptor_table_protodef_storage_2fagent_2fagent_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\031storage/agent/agent.proto\022\rlyric.stora"
    "ge\032\022common/agent.proto\"^\n\tAgentItem\022\016\n\002i"
    "d\030\001 \001(\tR\002id\022+\n\004type\030\002 \001(\0162\027.lyric.common"
    ".AgentTypeR\004type\022\024\n\005names\030\003 \003(\tR\005namesb\006"
    "proto3"
};
static const ::_pbi::DescriptorTable* PROTOBUF_NONNULL const
    descriptor_table_storage_2fagent_2fagent_2eproto_deps[1] = {
        &::descriptor_table_common_2fagent_2eproto,
};
static ::absl::once_flag descriptor_table_storage_2fagent_2fagent_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_storage_2fagent_2fagent_2eproto = {
    false,
    false,
    166,
    descriptor_table_protodef_storage_2fagent_2fagent_2eproto,
    "storage/agent/agent.proto",
    &descriptor_table_storage_2fagent_2fagent_2eproto_once,
    descriptor_table_storage_2fagent_2fagent_2eproto_deps,
    1,
    1,
    schemas,
    file_message_globals,
    TableStruct_storage_2fagent_2fagent_2eproto::offsets,
    file_level_enum_descriptors_storage_2fagent_2fagent_2eproto,
    file_level_service_descriptors_storage_2fagent_2fagent_2eproto,
};
namespace lyric {
namespace storage {
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.storage.AgentItem)
}
PROTOBUF_NDEBUG_INLINE AgentItem::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::storage::AgentItem& from_msg)
...
AgentItem::AgentItem(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.storage.AgentItem)
}
PROTOBUF_NDEBUG_INLINE AgentItem::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
...
AgentItem::~AgentItem() {
  // @@protoc_insertion_point(destructor:lyric.storage.AgentItem)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.storage.AgentItem)
...
::uint8_t* PROTOBUF_NONNULL AgentItem::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.storage.AgentItem)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_id().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.storage.AgentItem.id");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    for (int i = 0, n = this_._internal_names_size(); i < n; ++i) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          s.data(), static_cast<int>(s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.storage.AgentItem.names");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.storage.AgentItem)
  return target;
}
...
::size_t AgentItem::ByteSizeLong() const {
  const AgentItem& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.storage.AgentItem)
  ::size_t total_size = 0;
...
void AgentItem::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.storage.AgentItem)
...
void AgentItem::CopyFrom(const AgentItem& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.storage.AgentItem)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_storage_2fagent_2fagent_2eproto),
         ::std::false_type{});
