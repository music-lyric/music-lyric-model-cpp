...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        // ::lyric::storage::MetaText
        {&::_pbi::kDescriptorMethods, &::descriptor_table_storage_2fmeta_2fmeta_2eproto, /* tracker*/ nullptr,},
        // ::lyric::storage::MetaCredit
        {&::_pbi::kDescriptorMethods, &::descriptor_table_storage_2fmeta_2fmeta_2eproto, /* tracker*/ nullptr,},
        // ::lyric::storage::MetaUnknown
        {&::_pbi::kDescriptorMethods, &::descriptor_table_storage_2fmeta_2fmeta_2eproto, /* tracker*/ nullptr,},
        // ::lyric::storage::MetaReference
        {&::_pbi::kDescriptorMethods, &::descriptor_table_storage_2fmeta_2fmeta_2eproto, /* tracker*/ nullptr,},
        // ::lyric::storage::Meta
        {&::_pbi::kDescriptorMethods, &::descriptor_table_storage_2fmeta_2fmeta_2eproto, /* tracker*/ nullptr,},
};
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GetTable<::lyric::storage::MetaUnknown>(),  // to_prefetch
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GenericFallback,  // fallback
      #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
      ::_pbi::TcParser::GetTable<::lyric::storage::MetaText>(),  // to_prefetch
      #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
    }, {{
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GenericFallback,  // fallback
      #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
      ::_pbi::TcParser::GetTable<::lyric::storage::MetaReference>(),  // to_prefetch
      #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
    }, {{
    ...
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        ids_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::storage::MetaReference,
            PROTOBUF_FIELD_OFFSET(::lyric::storage::MetaReference, _impl_.ids_)>()
         }
        ,
        platform_(
            &::google::protobuf::internal::fixed_address_empty_string,
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GenericFallback,  // fallback
      #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
      ::_pbi::TcParser::GetTable<::lyric::storage::MetaCredit>(),  // to_prefetch
      #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
    }, {{
    ...
    {{
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::lyric::storage::MetaText>()},
        #else
        {::_pbi::FieldAuxMessageGlobals(), &::lyric::storage::MetaText_globals_},
        #endif
    }},
    {{
      "\30\4\0\0\0\0\0\0"
    ...
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        names_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::storage::MetaCredit,
            PROTOBUF_FIELD_OFFSET(::lyric::storage::MetaCredit, _impl_.names_)>()
         }
        ,
        role_(
            &::google::protobuf::internal::fixed_address_empty_string,
  ...
  return ParseTableT_{
    {
      ...
      ::_pbi::TcParser::GenericFallback,  // fallback
      #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
      ::_pbi::TcParser::GetTable<::lyric::storage::Meta>(),  // to_prefetch
      #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
    }, {{
    ...
    {{
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::lyric::storage::MetaUnknown>()},
        #else
        {::_pbi::FieldAuxMessageGlobals(), &::lyric::storage::MetaUnknown_globals_},
        #endif
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::lyric::storage::MetaText>()},
        #else
        ...
        #endif
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::lyric::storage::MetaCredit>()},
        #else
        {::_pbi::FieldAuxMessageGlobals(), &::lyric::storage::MetaCredit_globals_},
        #endif
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::lyric::storage::MetaReference>()},
        #else
        {::_pbi::FieldAuxMessageGlobals(), &::lyric::storage::MetaReference_globals_},
        #endif
    }},
    {{
    ...
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        unknowns_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::storage::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.unknowns_)>()
         }
        ,
        titles_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::storage::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.titles_)>()
         }
        ,
        artists_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::storage::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.artists_)>()
         }
        ,
        albums_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::storage::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.albums_)>()
         }
        ,
        authors_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::storage::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.authors_)>()
         }
        ,
        isrcs_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::storage::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.isrcs_)>()
         }
        ,
        credits_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::storage::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.credits_)>()
         }
        ,
        references_ { visibility, ::_pbi::InternalMetadataOffset::Build<
            ::lyric::storage::Meta,
            PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.references_)>()
         }
        ,
        offset_{0},
        duration_{0u} {}
...
static constexpr const ::_pb::EnumDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_enum_descriptors_storage_2fmeta_2fmeta_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_service_descriptors_storage_2fmeta_2fmeta_2eproto = nullptr;
const ::uint32_t
    TableStruct_storage_2fmeta_2fmeta_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::storage::MetaText, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::storage::MetaText, _impl_.language_),
        PROTOBUF_FIELD_OFFSET(::lyric::storage::MetaText, _impl_.content_),
        0,
        1,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::storage::MetaCredit, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::storage::MetaCredit, _impl_.role_),
        PROTOBUF_FIELD_OFFSET(::lyric::storage::MetaCredit, _impl_.names_),
        1,
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::storage::MetaUnknown, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::storage::MetaUnknown, _impl_.key_),
        PROTOBUF_FIELD_OFFSET(::lyric::storage::MetaUnknown, _impl_.value_),
        0,
        1,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::storage::MetaReference, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::storage::MetaReference, _impl_.platform_),
        PROTOBUF_FIELD_OFFSET(::lyric::storage::MetaReference, _impl_.ids_),
        1,
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_._has_bits_),
        13, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.unknowns_),
        PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.offset_),
        PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.duration_),
        PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.titles_),
        PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.artists_),
        PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.albums_),
        PROTOBUF_FIELD_OFFSET(::lyric::storage::Meta, _impl_.authors_),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::lyric::storage::MetaText)},
        {7, sizeof(::lyric::storage::MetaCredit)},
        {14, sizeof(::lyric::storage::MetaUnknown)},
        {21, sizeof(::lyric::storage::MetaReference)},
        {28, sizeof(::lyric::storage::Meta)},
};
static const ::_pbi::MessageGlobalsBase* PROTOBUF_NONNULL const
    file_message_globals[] = {
        &::lyric::storage::MetaText_globals_,
        &::lyric::storage::MetaCredit_globals_,
        &::lyric::storage::MetaUnknown_globals_,
        &::lyric::storage::MetaReference_globals_,
        &::lyric::storage::Meta_globals_,
};
const char descriptor_table_protodef_storage_2fmeta_2fmeta_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\027storage/meta/meta.proto\022\rlyric.storage"
    ...
    "\n\005names\030\002 \003(\0132\027.lyric.storage.MetaTextR\005"
    ...
    "ids\"\303\003\n\004Meta\0226\n\010unknowns\030\001 \003(\0132\032.lyric.s"
    "torage.MetaUnknownR\010unknowns\022\026\n\006offset\030\002"
    " \001(\021R\006offset\022\032\n\010duration\030\003 \001(\rR\010duration"
    "\022/\n\006titles\030\004 \003(\0132\027.lyric.storage.MetaTex"
    "tR\006titles\0221\n\007artists\030\005 \003(\0132\027.lyric.stora"
    "ge.MetaTextR\007artists\022/\n\006albums\030\006 \003(\0132\027.l"
    "yric.storage.MetaTextR\006albums\0221\n\007authors"
    "\030\007 \003(\0132\027.lyric.storage.MetaTextR\007authors"
    "\022\024\n\005isrcs\030\010 \003(\tR\005isrcs\0223\n\007credits\030\t \003(\0132"
    "\031.lyric.storage.MetaCreditR\007credits\022<\n\nr"
    "eferences\030\n \003(\0132\034.lyric.storage.MetaRefe"
    "renceR\nreferencesb\006proto3"
};
static ::absl::once_flag descriptor_table_storage_2fmeta_2fmeta_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_storage_2fmeta_2fmeta_2eproto = {
    false,
    false,
    785,
    descriptor_table_protodef_storage_2fmeta_2fmeta_2eproto,
    "storage/meta/meta.proto",
    &descriptor_table_storage_2fmeta_2fmeta_2eproto_once,
    nullptr,
    0,
    5,
    schemas,
    file_message_globals,
    TableStruct_storage_2fmeta_2fmeta_2eproto::offsets,
    file_level_enum_descriptors_storage_2fmeta_2fmeta_2eproto,
    file_level_service_descriptors_storage_2fmeta_2fmeta_2eproto,
};
namespace lyric {
namespace storage {
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.storage.MetaText)
}
PROTOBUF_NDEBUG_INLINE MetaText::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::storage::MetaText& from_msg)
...
MetaText::MetaText(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.storage.MetaText)
}
PROTOBUF_NDEBUG_INLINE MetaText::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
...
MetaText::~MetaText() {
  // @@protoc_insertion_point(destructor:lyric.storage.MetaText)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.storage.MetaText)
...
::uint8_t* PROTOBUF_NONNULL MetaText::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.storage.MetaText)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.storage.MetaText.language");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_content().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.storage.MetaText.content");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.storage.MetaText)
  return target;
}
...
::size_t MetaText::ByteSizeLong() const {
  const MetaText& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.storage.MetaText)
  ::size_t total_size = 0;
...
void MetaText::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.storage.MetaText)
...
void MetaText::CopyFrom(const MetaText& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.storage.MetaText)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.storage.MetaCredit)
}
PROTOBUF_NDEBUG_INLINE MetaCredit::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::storage::MetaCredit& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        names_ {
...
MetaCredit::MetaCredit(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.storage.MetaCredit)
}
PROTOBUF_NDEBUG_INLINE MetaCredit::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
MetaCredit::~MetaCredit() {
  // @@protoc_insertion_point(destructor:lyric.storage.MetaCredit)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.storage.MetaCredit)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL MetaCredit::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.storage.MetaCredit)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_role().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.storage.MetaCredit.role");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.storage.MetaCredit)
  return target;
}
...
::size_t MetaCredit::ByteSizeLong() const {
  const MetaCredit& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.storage.MetaCredit)
  ::size_t total_size = 0;
...
void MetaCredit::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.storage.MetaCredit)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
...
void MetaCredit::CopyFrom(const MetaCredit& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.storage.MetaCredit)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.storage.MetaUnknown)
}
PROTOBUF_NDEBUG_INLINE MetaUnknown::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::storage::MetaUnknown& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
MetaUnknown::MetaUnknown(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.storage.MetaUnknown)
}
PROTOBUF_NDEBUG_INLINE MetaUnknown::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
MetaUnknown::~MetaUnknown() {
  // @@protoc_insertion_point(destructor:lyric.storage.MetaUnknown)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.storage.MetaUnknown)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL MetaUnknown::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.storage.MetaUnknown)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    if (!this_._internal_key().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.storage.MetaUnknown.key");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_value().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.storage.MetaUnknown.value");
      target = stream->WriteStringMaybeAliased(2, _s, target);
    }
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.storage.MetaUnknown)
  return target;
}
...
::size_t MetaUnknown::ByteSizeLong() const {
  const MetaUnknown& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.storage.MetaUnknown)
  ::size_t total_size = 0;
...
void MetaUnknown::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.storage.MetaUnknown)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
...
void MetaUnknown::CopyFrom(const MetaUnknown& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.storage.MetaUnknown)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.storage.MetaReference)
}
PROTOBUF_NDEBUG_INLINE MetaReference::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::storage::MetaReference& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        ids_ {
          visibility, ::_pbi::InternalMetadataOffset::Build<
...
MetaReference::MetaReference(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.storage.MetaReference)
}
PROTOBUF_NDEBUG_INLINE MetaReference::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
MetaReference::~MetaReference() {
  // @@protoc_insertion_point(destructor:lyric.storage.MetaReference)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.storage.MetaReference)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL MetaReference::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.storage.MetaReference)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_platform().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.storage.MetaReference.platform");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    for (int i = 0, n = this_._internal_ids_size(); i < n; ++i) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          s.data(), static_cast<int>(s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.storage.MetaReference.ids");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.storage.MetaReference)
  return target;
}
...
::size_t MetaReference::ByteSizeLong() const {
  const MetaReference& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.storage.MetaReference)
  ::size_t total_size = 0;
...
void MetaReference::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  ::google::protobuf::Arena* arena = _this->GetArena();
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.storage.MetaReference)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
...
void MetaReference::CopyFrom(const MetaReference& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.storage.MetaReference)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lyric.storage.Meta)
}
PROTOBUF_NDEBUG_INLINE Meta::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::lyric::storage::Meta& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        unknowns_ {
          visibility, ::_pbi::InternalMetadataOffset::Build<
...
Meta::Meta(
  ...
  // @@protoc_insertion_point(copy_constructor:lyric.storage.Meta)
}
PROTOBUF_NDEBUG_INLINE Meta::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
Meta::~Meta() {
  // @@protoc_insertion_point(destructor:lyric.storage.Meta)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(message_clear_start:lyric.storage.Meta)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL Meta::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lyric.storage.Meta)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000020U)) {
    for (int i = 0, n = this_._internal_isrcs_size(); i < n; ++i) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          s.data(), static_cast<int>(s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lyric.storage.Meta.isrcs");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lyric.storage.Meta)
  return target;
}
...
::size_t Meta::ByteSizeLong() const {
  const Meta& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:lyric.storage.Meta)
  ::size_t total_size = 0;
...
void Meta::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  ::google::protobuf::Arena* arena = _this->GetArena();
  // @@protoc_insertion_point(class_specific_merge_from_start:lyric.storage.Meta)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
...
void Meta::CopyFrom(const Meta& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:lyric.storage.Meta)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_storage_2fmeta_2fmeta_2eproto),
         ::std::false_type{});
